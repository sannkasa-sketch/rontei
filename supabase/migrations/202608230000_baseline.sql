-- Baseline reconstructed from remote_public_schema.sql.
-- This represents the public application schema immediately before
-- 202608230001_add_question_post_relation.sql. Do not apply this file to the
-- existing remote project; it is intended for empty database reconstruction.
...
CREATE TABLE "public"."posts" (
    ...
    CONSTRAINT "posts_relation_parent_check" CHECK (((("relation_type" = 'main'::"text") AND ("parent_post_id" IS NULL)) OR (("relation_type" = ANY (ARRAY['agree'::"text", 'oppose'::"text", 'supplement'::"text"])) AND ("parent_post_id" IS NOT NULL)))),
    CONSTRAINT "posts_relation_type_check" CHECK (("relation_type" = ANY (ARRAY['main'::"text", 'agree'::"text", 'oppose'::"text", 'supplement'::"text"])))
);
...
CREATE TABLE "public"."topic_creators" (
    "topic_id" "uuid" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE TABLE "public"."topic_faction_scores" (
    "topic_id" "uuid" NOT NULL,
...
CREATE TABLE "public"."topic_member_faction_history" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "topic_member_id" "uuid" NOT NULL,
...
CREATE TABLE "public"."topic_member_factions" (
    "topic_member_id" "uuid" NOT NULL,
    "faction_id" "uuid" NOT NULL,
...
CREATE TABLE "public"."topic_member_werewolf_aliases" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "topic_id" "uuid" NOT NULL,
    "topic_member_id" "uuid" NOT NULL,
    "faction_id" "uuid" NOT NULL,
...
REVOKE ALL ON TABLE "public"."topic_faction_scores" FROM "anon";
REVOKE ALL ON TABLE "public"."topic_faction_scores" FROM "authenticated";
...
REVOKE ALL ON TABLE "public"."topic_member_factions" FROM "anon";
REVOKE ALL ON TABLE "public"."topic_member_factions" FROM "authenticated";

GRANT ALL ON TABLE "public"."topic_member_factions" TO "service_role";



REVOKE ALL ON TABLE "public"."topic_member_werewolf_aliases" FROM "anon";
REVOKE ALL ON TABLE "public"."topic_member_werewolf_aliases" FROM "authenticated";
